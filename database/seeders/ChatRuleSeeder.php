        ...
        $rules = [
            ...
            [
                'keywords' => [
                    ...
                    'cara pendaftaran yudisium online',
                    'langkah pendaftaran yudisium online',
                    'daftar yudisium online',
                    'alur yudisium online',
                    'alur mendaftar yudisium online',
                    'cara mendaftar yudisium online',
                    'tutorial daftar yudisium online',
                    'langkah yudisium online',
                ],
                'response' => "Pendaftaran Yudisium secara online dilakukan melalui portal resmi Sistem Informasi Akademik (SIA) UNISKA MAB di https://sia.uniska-bjm.ac.id.\n\n**Langkah & Alur Pendaftaran Yudisium Online di Portal SIA:**\n1. **Login Portal SIA:** Akses portal akademik SIA menggunakan NPM dan Password Anda, kemudian masuk ke Halaman Utama Dasbor.\n2. **Pilih Menu Yudisium:** Pilih menu \"Persyaratan Yudisium\", pastikan seluruh persyaratan akademik dan keuangan telah berstatus **Valid ('V')**, lalu klik tombol **DAFTAR YUDISIUM**.\n3. **Unggah Berkas Persyaratan:** Upload seluruh berkas persyaratan yudisium (seperti Ijazah SMA/sederajat, Kwitansi pembayaran, Lembar Pengesahan Skripsi, dll. dengan ukuran maksimal 100 KB per file), kemudian klik tombol **Upload / Simpan**.\n4. **Verifikasi Berkas:** Setelah pendaftaran online selesai dan mencetak bukti daftar, lakukan verifikasi berkas fisik ke loket BAK / Fakultas sesuai jadwal pelayanan.\n\n![1. Akses Portal Akademik SIA dan Login Akun](/assets/img/yudisium/langkah-1.jpeg)\n\n![2. Pilih Menu Persyaratan Yudisium dan Klik Daftar Yudisium](/assets/img/yudisium/langkah-2.jpeg)\n\n![3. Upload Berkas Persyaratan Yudisium (Maks 100 KB)](/assets/img/yudisium/langkah-3.jpeg)\n\n![Diagram Alur SOP Pendaftaran Yudisium Online](/assets/img/yudisium/sop-a.jpeg)",
                'category' => 'akademik',
                'priority' => 15,
            ],
            [
