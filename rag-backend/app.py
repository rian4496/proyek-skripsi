...
SOP_VISUAL_MAP = [
    {
        ...
        "images": [
            ("/assets/img/kalender/kalender_akademik_2025_2026.jpeg", "1. Kalender Akademik Resmi UNISKA MAB Tahun Ajaran 2025/2026 (Semester Ganjil, Genap, Yudisium & Wisuda)"),
        ]
    },
    {
        ...
        "images": [
            ...
            ("/assets/img/sia/urutan-2.jpeg", "2. Panduan Login Portal, Halaman Utama Setelah Login, dan Menu Profil"),
            ("/assets/img/sia/urutan-3.jpeg", "3. Form Mengubah Password Akun dan Navigasi Menu Ambil KRS"),
        ]
    },
    {
        ...
        "images": [
            ("/assets/img/sia/urutan-4.jpeg", "1. Tampilan Halaman Ambil KRS - Memilih Mata Kuliah dan Kelas Semester 1"),
            ("/assets/img/sia/urutan-5.jpeg", "2. Daftar Mata Kuliah Lanjutan Semester 2 hingga Semester 4"),
            ("/assets/img/sia/urutan-6.jpeg", "3. Daftar Mata Kuliah Semester 5 hingga 8 dan Tombol Hijau Simpan Ambil KRS"),
        ]
    },
    {
        ...
        "images": [
            ("/assets/img/sia/urutan-7.jpeg", "1. Menu Navigasi Hapus KRS dan Halaman Proses Hapus Mata Kuliah"),
        ]
    },
    {
        ...
        "images": [
            ("/assets/img/sia/urutan-8.jpeg", "1. Menu Navigasi Cetak KRS, Halaman KRS, dan Jendela Print KRS"),
        ]
    },
    {
        ...
        "images": [
            ("/assets/img/sia/urutan-9.jpeg", "1. Menu Navigasi KHS, Pilih Periode Semester, dan Tampilan Nilai KHS"),
            ("/assets/img/sia/urutan-10.jpeg", "2. Jendela Print KHS dan Menu Navigasi Transkrip Nilai"),
        ]
    },
    {
        ...
        "images": [
            ("/assets/img/sia/urutan-11.jpeg", "1. Ikon Kaca Pembesar dan Tampilan Awal Transkrip Nilai Mahasiswa"),
            ("/assets/img/sia/urutan-12.jpeg", "2. Tabel Lengkap Transkrip Nilai - Daftar Mata Kuliah dan IPK Akhir"),
            ("/assets/img/sia/urutan-13.jpeg", "3. Ikon Printer Cetak Transkrip dan Jendela Print Transkrip Nilai Resmi"),
        ]
    },
    {
        ...
        "images": [
            ("/assets/img/yudisium/sop-a.jpeg", "1. Diagram Alur SOP Pendaftaran Yudisium Online (Mahasiswa & Operator BAK)"),
            ("/assets/img/yudisium/sop-b.jpeg", "2. Diagram Alur SOP Verifikasi Pengajuan Yudisium Tatap Muka / Offline"),
        ]
    },
    {
        ...
        "images": [
            ("/assets/img/yudisium/langkah-1.jpeg", "1. Akses Portal Akademik SIA, Login Akun, dan Masuk ke Halaman Utama Dasbor"),
            ("/assets/img/yudisium/langkah-2.jpeg", "2. Pilih Menu Persyaratan Yudisium, Pastikan Syarat Berstatus 'V', dan Klik DAFTAR YUDISIUM"),
            ("/assets/img/yudisium/langkah-3.jpeg", "3. Upload Berkas Persyaratan Yudisium (Ijazah SMA, Kwitansi, dll Maks. 100 KB) dan Klik Upload"),
        ]
    },
]
